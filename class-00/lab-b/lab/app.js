...
//     in this case (this) refers to the object joe created by the constructer Student

// 2. What is "this" when joe.scopeArrow() is invoked?
//     in this case (this) refers to the global object window
// 3. Explain why "this" is different when an arrow function is used.
//     arrow functions don't have their own this but they inherit it from the parent scope which is in this case the global one (window)
